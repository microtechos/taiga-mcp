...
export function registerRoleTools(server, client) {
    server.tool("taiga_roles_list", "List roles. Filter by project.", { project: z.number().optional().describe("Project ID") }, async (params) => {
    ...
    server.tool("taiga_roles_create", "Create a new role.", {
    ...
    server.tool("taiga_roles_get", "Get a role by ID.", { id: z.number().describe("Role ID") }, async ({ id }) => {
    ...
    server.tool("taiga_roles_update", "Update a role (partial).", {
    ...
    server.tool("taiga_roles_delete", "Delete a role.", { id: z.number().describe("Role ID") }, async ({ id }) => {
